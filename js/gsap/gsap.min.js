...
!(function (t, e) {
  ...
  function Ja(t, e) {
    var r;
    if (
      ((e._time || (e._initted && !e._dur)) && ((r = Ga(t.rawTime(), e)), (!e._dur || kt(0, e.totalDuration(), r) - e._tTime > V) && e.render(r, !0)),
  ...
  function Pb(t, e) {
    for (var r, i = t._first; i; )
      i instanceof Ut
        ? Pb(i, e)
        : !i.vars.yoyoEase || (i._yoyo && i._repeat) || i._yoyo === e || (i.timeline ? Pb(i.timeline, e) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = e))),
        (i = i._next);
  }
  function Rb(t, e, r, i) {
    void 0 === r &&
  ...
  function wl(t) {
    var e,
      ...
      s = !0 === t;
    if (
      (O < a && (A += a - C), (0 < (e = (i = (D += a) - A) - z) || s) && ((n = ++g.frame), (b = i - 1e3 * g.time), (g.time = i /= 1e3), (z += e + (E <= e ? 4 : E - e)), (r = 1)), s || (p = _(wl)), r)
    )
          ...
          if (_ <= i && 0 <= t)
            ...
            for (var w = t < 0 ? t : i; n; ) {
              if (((a = n._prev), (n._act || w <= n._end) && n._ts && h !== n)) {
                if (n.parent !== this) return this.render(t, e, r);
                if (
                  (n.render(0 < n._ts ? (w - n._start) * n._ts : (n._dirty ? n.totalDuration() : n._tDur) + (w - n._start) * n._ts, e, r || (B && (n._initted || n._startAt))),
    ...
    Ht = function _initTween(t, e, r) {
      ...
      if (
        ...
        if (
          ...
          (i = ua(m, ft)),
          S && (S._zTime < 0 && S.progress(1), e < 0 && M && y && !C ? S.render(-1, !0) : S.revert(M && A ? ht : ut), (S._lazy = 0)),
          v)
        ) {
          if (
            (za(
              (t._startAt = Gt.set(
                R,
                qa({ data: "isStart", overwrite: !1, parent: D, immediateRender: !0, lazy: w(T), startAt: null, delay: 0, onUpdate: b, onUpdateParams: x, callbackScope: k, stagger: 0 }, v)
              ))
            ),
          ...
          if (
            (e && (y = !1),
            (a = qa({ overwrite: !1, data: "isFromStart", lazy: y && w(T), immediateRender: y, stagger: 0, parent: D }, i)),
            p && (a[l.prop] = p),
        ...
        if (p) {
          ...
          !(function _renderZeroDurationTween(t, e, r, i) {
            ...
            if (
              (h &&
                t._repeat &&
                ((l = kt(0, t._tDur, e)), (a = Tt(l, h)), t._yoyo && 1 & a && (u = 1 - u), a !== Tt(t._tTime, h) && ((o = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
  ...
  function Td(e) {
    ...
    return (
      ...
      !r || r.width || r.x || r.y ? r : { x: +Sd(e, ["x", "cx", "x1"]) || 0, y: +Sd(e, ["y", "cy", "y1"]) || 0, width: 0, height: 0 }
    );
  }
  function Ud(t) {
  ...
  (Ce.utils.checkPrefix = dr),
    ...
    (Rr = ha(
      (Ar = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") + "," + (Sr = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective",
      function (t) {
        rr[t] = 1;
      }
    )),
